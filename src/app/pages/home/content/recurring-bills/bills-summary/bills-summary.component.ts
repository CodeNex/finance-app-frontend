...
export class BillsSummaryComponent {
  ...
  private getRemainingWeeklyOccurrences(billDate: Date): number {
    ...
    switch (this.selectedTimeWindow) {
      case 'monthly':
        endOfPeriod = new Date(currentYear, currentMonth, this.getLastDayOfMonth(currentYear, currentMonth));
        break;
  
      case 'quarterly': {
        const quarterStartMonth = Math.floor(currentMonth / 3) * 3;
        const quarterEndMonth = quarterStartMonth + 2;
        endOfPeriod = new Date(currentYear, quarterEndMonth, this.getLastDayOfMonth(currentYear, quarterEndMonth));
        break;
      }
      ...
      case 'nextMonth':
        ...
        endOfPeriod = new Date(currentYear, currentMonth + 1, this.getLastDayOfMonth(currentYear, currentMonth + 1));
        break;
  
      case 'nextThreeMonths':
        startOfPeriod = new Date(currentYear, currentMonth + 1, 1);
        endOfPeriod = new Date(currentYear, currentMonth + 3, this.getLastDayOfMonth(currentYear, currentMonth + 3));
        break;
  
      case 'nextSixMonths':
        startOfPeriod = new Date(currentYear, currentMonth + 1, 1);
        endOfPeriod = new Date(currentYear, currentMonth + 6, this.getLastDayOfMonth(currentYear, currentMonth + 6));
        break;
